...
libname tsa "&path/SAS_Base_Coursera-master/wk3_tsa_claims_project";
options validvarname=v7;

/* reading in csv values */
proc import datafile = "&path/ECRB94/data/TSAClaims2002_2017.csv" 
		dbms = csv
		out = claims_raw		 
		replace;
	guessingrows=max;
...
%let outpath=/folders/myfolders/ECRB94/Report;
